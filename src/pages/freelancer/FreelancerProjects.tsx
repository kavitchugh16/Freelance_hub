...
//       try {
//         const res = await axios.get("http://localhost:8080/api/projects/my-freelancer-projects", { 
...
interface Project {
  ...
  finalAmount: number; // This will always be present for a freelancer's assigned project
  clientId?: {
      username: string;
  }
}
      ...
      {projects.length === 0 ? (
        ...
        projects.map((p) => (
          <div key={p._id} className="border rounded-md p-4 mb-3 shadow-sm bg-gray-50">
            ...
            {/* --- ✅ CHANGED: Improved label and formatting --- */}
            <p className="text-sm text-gray-500">
              <strong>Your Fee:</strong> ${p.finalAmount?.toFixed(2)} {p.budget?.currency}
            </p>
