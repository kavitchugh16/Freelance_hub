...
const ClientDetails = () => {
  ...
  // Prefill from local user and backend, if available
  useEffect(() => {
    try {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // Persist client profile locally for dashboard usage
            ...
            <Card className="border-blue-200 shadow-md">
              ...
              <CardContent className="p-6">
                <div className="flex flex-col items-center">
                  <div
                    className="w-32 h-32 bg-blue-100 border-2 border-dashed border-blue-300 rounded-lg flex items-center justify-center hover:border-blue-400 transition-colors cursor-pointer overflow-hidden"
                  ...
                  >
                    {!formData.companyLogo && <Camera className="h-8 w-8 text-blue-400" />}
                  </div>
                  <input
                    ref={fileInputRef}
                    type="file"
                  ...
                  />
                  <Button type="button" variant="outline" className="mt-4 text-blue-600 border-blue-300 hover:bg-blue-50" onClick={() => fileInputRef.current?.click()}>
              ...
              <CardContent className="p-6">
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <Label htmlFor="contactEmail" className="text-blue-900 font-medium">Contact Email *</Label>
                      <Input
                        id="contactEmail"
                        type="email"
